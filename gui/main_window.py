...
class MainWindow(QMainWindow):
    ...
    def _build_ui(self):
        ...
        # Selección de tipos de archivo a generar (checkbox + descripción en una sola fila)
        tipo_archivo_box = QGroupBox("Archivos a crear:")
        tipo_archivo_hlayout = QHBoxLayout()
        tipo_archivo_hlayout.setSpacing(6)
        self.chk_pdf = QCheckBox("Generar PDF")
        self.chk_pdf.setChecked(True)
        tipo_archivo_hlayout.addWidget(self.chk_pdf)
        tipo_archivo_hlayout.addSpacing(24)
        self.chk_ics = QCheckBox("Generar Google/Apple Calendar (ICS)")
        self.chk_ics.setChecked(True)
        tipo_archivo_hlayout.addWidget(self.chk_ics)
        tipo_archivo_hlayout.addStretch()
        tipo_archivo_box.setLayout(tipo_archivo_hlayout)
